...
To assemble the project you need to have the PCB, the necessary components, and some basic soldering skills. Our PCB were produced by JLCPcb for really cheap (Like 3$ for 5 PCBs), from the Gerber file that we sent them. You can find where the components goes in the scheme you can find [here](HARDWARE/OPENDRUMS_V1.0_circuit_schematic.pdf). 
