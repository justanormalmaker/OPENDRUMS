...
If you want to complete you project you can also 3d print [this]([HARDWARE/OPENDRUMS_prototipe_case.stl](https://github.com/justanormalmaker/OPENDRUMS/blob/main/HARDWARE/CASE%20(Per%20prototipo%20v0.1)/OPENDRUMS_prototipe_case.stl)) case (it's for the 0.1v, we are going to release the 1.0v soon :) )
