...
- You CAN use, modify, and distribute this code, including for commercial
  products.
- If you distribute a modified version, the source code of your version
  MUST also be made available under GPL-3.0.
- Original copyright and license notices must be preserved.

## Third-party libraries

This firmware uses third-party libraries that are NOT relicensed under
GPL-3.0 — they remain under their own original licenses (MIT, BSD, LGPL),
as permitted by GPL-3.0's compatibility rules for linked/aggregated works.
See THIRD-PARTY-LICENSES.md for full attribution.
